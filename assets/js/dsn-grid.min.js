...
const dsnGrid = {
    isMobile: function (e = !0) {
        ...
        return e = this.convertToJQuery(e), Splitting({
            ...
            $(this).attr("style", "display:unset;--char-dsn-index:" + e)
        ...
        let o = window.performance.timing, r = -1 * (o.loadEventEnd - o.navigationStart) / 1e3 % 50 * 10, s = e,
            a = t > e ? 1 : -1, d = Math.abs(Math.floor((r + n) / 100)), l = setInterval((function () {
        ...
        if (!(n.length <= 0) || e.imgs.length) return delete t.parent, e.parent = n.get(0), n = null, new function (e, t, n) {
            var i, o = t.parent || console.warn("no parent"),
                r = t.displacement || console.warn("displacement image missing"), s = [], a = this, d = !1,
                l = e.convertToJQuery(n.nextEl), c = e.convertToJQuery(n.prevEl), h = 0, u = 0;
        ...
        return {
            set: function (e, t, n) {
                ...
                let t = e + "=", n = decodeURIComponent(document.cookie), i = n.split(";");
        ...
        if (i <= s && void 0 !== n.action) {
            var l = i - s, c = l / d, h = s / (t.height() + i + o);
        ...
        var a = r.html(), d = $('<div class="icon-circle"></div>'),
            l = $('<div class="dsn-grid-parallax">' + a + "</div>");
        r.html(""), r.append(d), r.append(l), r.on("mouseleave", (function (e) {
            TweenMax.to(r, n, {scale: 1}), TweenMax.to(l, .3, {scale: 1, x: 0, y: 0}), TweenMax.to(d, n, {
                scale: 1,
                x: 0,
                y: 0
            })
