!function (e) {
    ...
    async function t(t) {
        await dsnGrid.destoryBuild(), await a("poster"), await a("src"), await a("srcset"), t || (window.$effectScroll = await function () {
            ...
            return {
                allInt: function () {
                    ...
                    const t = e(".next-project"), n = t.find(".case img"), i = t.find(".bg img"), a = t.find(".title"),
                        s = gsap.timeline();
                    if (!t.length) return;
                    ...
                    const o = dsnGrid.tweenMaxParallax($controller).addParrlax({
                        ...
                        triggerHook: 1,
                        duration: "95%",
                        tween: gsap.timeline({yoyo: !0}).fromTo(i, {
                            y: -100,
                            scale: 1,
                            yoyo: !0,
                            overwrite: "none"
                        }, {y: 0, scale: 1.2}, 0).fromTo(t.find(".project-number , .metas"), {
                            y: -100,
                            yoyo: !0,
                            overwrite: "none"
                        }, {y: 0}, 0)
                    ...
                    l.on("progress", (function (e) {
                        t.find(".case .number").text((100 * e.progress).toFixed(0) + "%"), i.css({filter: "blur(" + (10 - 10 * e.progress) + "px)"}), e.progress > .998 && t.find("a").click()
                    })), l && $scene.push(l)
                    ...
                    e(".dsn-header-animation").each((function () {
                        let n = e(this), i = n.find(".dsn-hero-parallax-img"), a = n.find(".dsn-hero-parallax-title");
                        ...
                        i.length && s.to(i, {
                            ...
                            ease: t,
                            overwrite: "none"
                        }, 0), a.length && s.to(a, {y: "-15%", autoAlpha: 0, yoyo: !0, ease: t, overwrite: "none"}, 0);
                    ...
                    const n = dsnGrid.tweenMaxParallax($controller).addParrlax({
                        ...
                        tween: gsap.to(".scroll-to-top > img", .3, {rotation: t.height() / 2})
                    });
        ...
        }().init(), await dsnGrid.removeWhiteSpace(".site-header ul.extend-container li > a"), await function () {
            const t = e(".box-options");
            t.find(".title-mode").each((function () {
                dsnGrid.convertTextLine(this)
            })), t.find(".day-night").on("click", (function () {
                const t = e(".v-dark"), n = e(".v-light");
        ...
        }()), t && await o(t), e("a.vid").YouTubePopUp(), await function (t) {
            ...
            return {
                run: async function () {
                    ...
                    t.on("slideChange", (async function () {
                        let o = i.find(".dsn-slider-content .dsn-active"), l = o.data("dsn-id"),
                            r = e(t.slides[t.activeIndex]), d = r.data("dsn-id");
                        if (l === d) return;
                        ...
                        let h = i.find('.dsn-slider-content [data-dsn-id="' + d + '"]'),
                            u = h.find(".dsn-chars-wrapper"), p = l > d;
                    ...
                    let o = e.find(".dsn-slider-content .dsn-active").find(".dsn-chars-wrapper"),
                        l = e.find('.dsn-slider-content [data-dsn-id="' + i + '"]'), r = l.find(".dsn-chars-wrapper");
    ...
    function n() {
        ...
        return {
            ajaxLoad: function () {
            ...
            }, mainRoot: e("main.main-root"), ajaxClick: e("a.effect-ajax "), effectAjax: function (e) {
                ...
                let n = t.parents(".slide-content"), i = n.data("dsn-id"),
                    ...
                    s = n.find(".title"), o = n.parents(".main-slider").find(".bg-container");
                ...
                let t = e.parents(".next-project"), n = t.find(".bg"), i = e;
                const s = window.Scrollbar.get(document.querySelector("#dsn-scrollbar"));
                a.to(s || $wind, 1, {scrollTo: {y: s ? $effectScroll.getScrollbar().limit.y : document.body.scrollHeight}}), a.call(this.dsnCreateElement.bind(this, n, t, i.find(".title"), i, {
                ...
                let t = e.parents(".work-item"), i = t.find(".box-img"), s = t.find(".sec-title");
    ...
    function s() {
        e(".dsn-isotope").each((t, n) => {
            ...
            const t = e(this).find(".filtering-t "), n = e(this).find(".dsn-item-filter");
    ...
    !function () {
        let n = e(".preloader"), a = n.find(".percent"), s = n.find(".title .text-fill"), o = {value: 0},
            l = n.find(".preloader-bar"), r = l.find(".preloader-progress"),
        ...
        $wind.on("load", (function () {
            ...
            }).to(n.find("> *"), {y: -30, autoAlpha: 0}).call((function () {
                n.length && (i(), t().catch(e => {
                    console.log(e)
                }))
